    ...
    while len(a_list) != 0 :
        ...
        if ( ch == '1' or ch == '2' or ch == '3' or ch == '4' or ch == '5' or ch == '6' or ch == '7' ) :
            ...
            if ( ch == '1' or ch == '2' or ch == '3' or ch == '4' or ch == '5' or ch == '6' or ch == '7' ) : # 有三個課程時間
                ...
                A_NEW_bubble["body"]["contents"][1]["text"] = teacher # 授課老師           
                A_NEW_bubble["body"]["contents"][2]["text"] = time_place_1 # 上課時間1   
                A_NEW_bubble["body"]["contents"][3]["text"] = time_place_2 # 上課時間2
                A_NEW_bubble["body"]["contents"][4]["text"] = time_place_3 # 上課時間3                 
                A_NEW_bubble["footer"]["contents"][0]["action"]["data"] = course_id # 加入我的課表編號
